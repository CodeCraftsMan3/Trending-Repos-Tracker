...
- [dynamodb-shell](https://github.com/awslabs/dynamodb-shell): A command line client (shell) for AWS DynamoDB that offers DDL and DML support similar to CLIs for other databases.
...
- [lara-date-filter](https://github.com/omarelnaghy/lara-date-filter): A Laravel package for advanced date filtering and manipulation
